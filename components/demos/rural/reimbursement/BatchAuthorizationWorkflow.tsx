  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-2">
        ...
        {items.map((i) => (
          <div key={i.orderId} className="flex flex-wrap items-center justify-between gap-2 rounded-lg border border-arka-light bg-arka-bg-alt px-3 py-2 text-sm text-arka-text-dark">
            <div>
