  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <header className="mb-8 max-w-3xl">
        <h1 className="text-3xl font-bold tracking-tight text-arka-text-dark dark:text-white">
          Live CDS Hooks Integration
        </h1>
        <FDANonDeviceBanner product="CLIN" className="mt-4 rounded-lg" />
        <p className="mt-4 text-base leading-relaxed text-arka-text-dark-muted">
