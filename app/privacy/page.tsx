...
export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-16 text-arka-text-dark">
      <h1 className="text-3xl font-semibold text-arka-text-dark">Privacy Policy</h1>
      <p className="mt-2 text-sm text-arka-text-dark-muted">Last updated: {LAST_UPDATED}</p>

      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">1. Introduction.</h2>
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">2. Scope and applicability.</h2>
      <p className="mb-4 text-base leading-relaxed text-arka-text-dark">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">
        3. No PHI in the public Site or demos.
      </h2>
      <p className="mb-4 text-base leading-relaxed text-arka-text-dark">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">4. Information we collect.</h2>
      <p className="mb-4 text-base leading-relaxed text-arka-text-dark">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">5. How we use information.</h2>
      <p className="mb-4 text-base leading-relaxed text-arka-text-dark">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">7. Sharing and disclosure.</h2>
      <p className="mb-4 text-base leading-relaxed text-arka-text-dark">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">8. Cookies and analytics.</h2>
      <p className="mb-4 text-base leading-relaxed text-arka-text-dark">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">9. Data retention.</h2>
      <p className="mb-4 text-base leading-relaxed text-arka-text-dark">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">10. Security.</h2>
      <p className="mb-4 text-base leading-relaxed text-arka-text-dark">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">11. International transfers.</h2>
      <p className="mb-4 text-base leading-relaxed text-arka-text-dark">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">12. Your rights.</h2>
      <p className="mb-4 text-base leading-relaxed text-arka-text-dark">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">13. Children&apos;s privacy.</h2>
      <p className="mb-4 text-base leading-relaxed text-arka-text-dark">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">14. Third-party links and content.</h2>
      <p className="mb-4 text-base leading-relaxed text-arka-text-dark">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">16. Changes to this Privacy Policy.</h2>
      <p className="mb-4 text-base leading-relaxed text-arka-text-dark">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-arka-text-dark">17. Contact.</h2>
      <p className="mb-4 text-base leading-relaxed text-arka-text-dark">
        ARKA Health, Inc. | Attn: Privacy | privacy@getarka.health.
      </p>
    </main>
  );
}
