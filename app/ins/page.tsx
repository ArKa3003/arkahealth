    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 sm:mb-8 flex flex-wrap items-center gap-3 text-sm">
          <span className="text-arka-text-dark-muted">Other demos:</span>
        ...
        <section className="mb-6 sm:mb-8" aria-labelledby="about-arka-ins-heading">
          <button
            ...
            className="arka-card w-full flex min-h-[44px] items-center justify-between gap-4 rounded-xl border border-arka-light p-4 text-left transition-all hover:border-arka-teal/40 touch-manipulation"
          ...
          >
            <div className="arka-card mt-2 rounded-xl border border-arka-light p-4 sm:p-6 space-y-4 text-arka-text-dark-muted text-sm">
              <p>
                <strong className="text-arka-text-dark">RBM workflow benefits.</strong> ARKA-INS guides prior authorization through evidence-based RBM (Radiology Benefit Management) criteria. 
              ...
              <p>
                <strong className="text-arka-text-dark">Prior authorization assistance.</strong> The demo includes denial risk prediction, AI-generated clinical justification, 
              ...
              <p>
                <strong className="text-arka-text-dark">Connection to clinical and educational insights.</strong> ARKA-INS aligns with ARKA-CLIN (imaging appropriateness) and ARKA-ED (education). 
        ...
        {/* AIIE for Utilization Management - brief intro + stats */}
        <AIIEForUtilizationManagementSection />

        {/* How ARKA-INS Works for RBMs - workflow + benefits */}
        <HowArkaInsWorksSection />
