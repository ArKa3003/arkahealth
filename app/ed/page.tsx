...
import { IntroducingAIIESection } from "@/components/demos/ed/IntroducingAIIESection";
      ...
      <div className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <nav aria-label="Breadcrumb" className="mb-4 sm:mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-sm font-medium text-arka-text-dark-muted">
            ...
            <li className="flex items-center gap-1.5">
              ...
              <span className="text-arka-teal">ARKA-ED</span>
            </li>
          </ol>
        </nav>
        ...
        <section className="mb-6 sm:mb-8" aria-labelledby="about-arka-ed-heading">
          <button
            ...
            className="arka-card w-full flex min-h-[44px] items-center justify-between gap-4 rounded-xl border border-arka-light p-4 text-left transition-all hover:border-arka-teal/30 touch-manipulation"
          ...
          >
            <span className="flex items-center gap-2 font-semibold text-arka-text-dark">
              <GraduationCap className="h-5 w-5 text-arka-teal" aria-hidden />
              About ARKA-ED
            </span>
            <ChevronDown
          ...
          >
            <div className="arka-card mt-2 rounded-xl border border-arka-light p-4 sm:p-6 space-y-4 font-sans text-arka-text-dark-muted">
              <div>
                <h3 className="font-semibold text-arka-text-dark mb-1">Learning objectives</h3>
              ...
              <div>
                <h3 className="font-semibold text-arka-text-dark mb-1">Target audience</h3>
                <p className="text-sm sm:text-base">
                  <strong className="text-arka-text-dark">Students and residents</strong> in emergency
              ...
              <div>
                <h3 className="font-semibold text-arka-text-dark mb-1">How insights inform ARKA-CLIN protocols</h3>
                <p className="text-sm sm:text-base">
                  The same evidence base and scoring logic that power ARKA-ED cases feed into{" "}
                  <strong className="text-arka-text-dark">ARKA-CLIN</strong> clinical decision support.
        ...
        {/* Introducing AIIE */}
        <IntroducingAIIESection />

        {/* Demo content (Case list → Case viewer) */}
        <EdDemoContent />

        {/* Cross-links to other demos */}
        <footer className="mt-12 sm:mt-16 pt-8 border-t border-arka-light">
          <p className="text-sm font-medium text-arka-text-dark-muted mb-3">
            Also explore:{" "}
            <Link href={routes.clin} className="text-arka-teal hover:underline">
              ARKA-CLIN
            </Link>
            {" | "}
