...
export const metadata: Metadata = {
  ...
  description: "Emergency department imaging workflow and CDS demo.",
};
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <p className="mt-4 text-neutral-600 dark:text-neutral-400">
        Emergency department imaging workflow and clinical decision support.
        This demo will host the ARKA-ED workflow and CDS components.
      </p>
      <div className="mt-12 rounded-xl border border-dashed border-neutral-300 bg-neutral-50 p-12 text-center dark:border-neutral-600 dark:bg-neutral-800/30">
        <p className="text-neutral-500 dark:text-neutral-400">
          ARKA-ED demo content coming soon.
        </p>
      </div>
    </div>
  );
