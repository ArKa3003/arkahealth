...
- **`docs/CLINICAL_SIGN_OFF_LOG.md`** — Clinician sign-off ledger for catalogue and rule changes [TODO: signatures pending for several entries].
- **`docs/CDS_CARD_LANGUAGE_STYLE_GUIDE.md`** — Non-coercive CDS copy conventions [TODO: to be created in Prompt 11.C].
